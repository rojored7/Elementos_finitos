function [Stress_cent,Stress] = FEM_EV_Hexa_Stress(E,v,ui,uj,uk,ul,um,un,uo,up,Des)


%% MÉTODO DE ELEMENTOS FINITOS (MEF o FEM): Elemento con Volumen (Hexaedro) - Esfuerzos (Stress)
...
% Stress_cent       ::>  Esfuerzo en el centroide - coordenadas (0,0,0)
% Stress            ::>  Esfuerzo - en cualquier coordenada (s,t,u)
%                           Esf_x  : Esfuerzo normal en x
%                           Esf_y  : Esfuerzo normal en y
%                           Esf_z  : Esfuerzo normal en z
%                           Esf_xy : Esfuerzo cortante en x-y
%                           Esf_yz : Esfuerzo cortante en y-z
%                           Esf_xz : Esfuerzo cortante en x-z
...
if ok == 1
    ...
    Stress_cent = subs(Stress, {s,t,u}, {0,0,0});
